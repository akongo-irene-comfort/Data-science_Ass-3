...
def train_dqn(args):
    ...
    for episode in range(args.episodes):
        ...
        for step in range(args.max_steps_per_episode):
            ...
            # Train the network
            if len(replay_buffer) >= args.batch_size and global_step >= args.warmup_steps:
        ...
        if episode % args.log_interval == 0:
            ...
            writer.add_scalar('Episode/WaitingTime', info.get('avg_waiting_time', 0), episode)
            writer.add_scalar('Episode/QueueLength', info.get('avg_queue_length', 0), episode)
